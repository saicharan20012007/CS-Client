...
export default function ViewModal({ project }) {
  console.log(project);
        ...
        <Fade in={open}>
          <ModalContent sx={style}>
            ...
            <Box
              ...
              <h2 style={{ marginBottom: "5px" }}>Project Details</h2>
                ...
                <div style={{ marginBottom: "-15px" }}>
                  ...
                  <div
                    ...
                    <div
                      ...
                      <span>Email*</span>
                      <h5 id="transition-modal-title" style={labelStyles}>
                        {project.projectSupervisor.email}
                      </h5>
                    </div>
                    <div
                      style={{
                      ...
                      <h5 id="transition-modal-title" style={labelStyles}>
                        {project.projectSupervisor.contactNumber}
                      </h5>
                    </div>
                    <div
                      style={{
                      ...
                      <span>Role*</span>
                      <h5 id="transition-modal-title" style={labelStyles}>
                        {project.projectSupervisor.role}
                      </h5>
                    </div>
                  </div>
                </div>
