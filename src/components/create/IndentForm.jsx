...
import { createIndent } from "../../redux/indent/action";
...
const IndentForm = ({ title }) => {
  ...
  const handleSubmit = async (event) => {
    ...
    dispatch(createIndent(indentDetails, accessToken)).then((res) => {
      if (res.type === "CREATE_INDENT_SUCCESS") {
    ...
    // try {
    //   setIsLoading(true);
    //   await axios.post("/indent/create/", {
    //     materialname,
    //     unitofmaterial,
    //     projectname,
    //     taskName,
    //     Supervisorname,
    //     expectedateofdelivery,
    //   });
